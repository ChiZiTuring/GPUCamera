...
import com.gyb.android.gpucamera.filter.AFilter;
import com.gyb.android.gpucamera.filter.EasyGlUtils;
import com.gyb.android.gpucamera.filter.GroupFilter;
import com.gyb.android.gpucamera.filter.MatrixUtils;
import com.gyb.android.gpucamera.filter.NoFilter;
...
//    private GroupFilter mAfFilter;
    ...
    private boolean mTestBiggerView = false;
...
//        mAfFilter.create();
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        this.width = width;
        this.height = height;
        this.HWRate = (float)height / width;
...
//            mAfFilter.setSize(mPreviewWidth,mPreviewHeight);
        ...
        Log.d(TAG,"preview width = " + mPreviewWidth + " preview height = " + mPreviewHeight);
...
//
//        if(mTestBiggerView) {
//            MatrixUtils.getShowMatrix(EM, mPreviewWidth, mPreviewHeight, width , height );
//            EM[0] = EM[0] * (1.0f + mTestCount * 0.1f);
//            EM[5] = EM[5] * (1.0f + mTestCount * 0.1f);
//            mShowFilter.setMatrix(EM);
//            mTestCount++;
//            Log.d(TAG,"mTestBiggerView = " + mTestBiggerView + " mTestCount = " + mTestCount);
//        }else{
//            MatrixUtils.getShowMatrix(SM, mPreviewWidth, mPreviewHeight, width, height);
//            mShowFilter.setMatrix(SM);
//            mTestCount = 0;
...
//        mShowFilter.setTextureId(mAfFilter.getOutputTexture());
        mShowFilter.setTextureId(fTexture[0]);
        mShowFilter.draw();
//
//        callbackIfNeeded();
...
*/
    ...
    */
    ...
    public void setBiggerView(boolean bBiggerView){
        mTestBiggerView = bBiggerView;
    }
}
